...
## Top Opportunities
- IDEA-001 — Monetization 10/10、Urgency 5.5/10，适合先做轻量验证再决定是否深入。 — evidence: 28 条证据，最近证据距今 0.07 小时，来源集中在 web-discovery-default-1。
- IDEA-002 — Monetization 5/10、Urgency 7/10，适合先做轻量验证再决定是否深入。 — evidence: 10 条证据，最近证据距今 0.06 小时，来源集中在 web-discovery-default-2。
